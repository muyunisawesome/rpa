...
public class SendmailFrame extends JFrame {
	...
	public SendmailFrame() {
		setIconImage(Toolkit.getDefaultToolkit().getImage(ResourceLoad.load("resource/imag/Sendmailframe.png")));
  ...
  sendButton.addMouseListener(new MouseAdapter() {
    ...
    for(int j=0;j<t.length();j++)
    {
	   ...
	   catch (Exception e1)
	   {
		...
		lblNewLabel.setIcon(new ImageIcon(ResourceLoad.load("resource/imag/sendmail.jpg")));
