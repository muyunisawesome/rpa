...
public class RoomList extends JFrame {
    ...
    JPanel floatPane = new JPanel() {
        protected void paintComponent(Graphics g) {
            Image image = new ImageIcon(ResourceLoad.load("resource/imag/floatPane.png")).getImage();
    ...
    public RoomList(Home home, final User user) {
        ...
        JPanel panel = new JPanel() {
            protected void paintComponent(Graphics g) {
                Image image = new ImageIcon(ResourceLoad.load("resource/imag/ting.png")).getImage();
                g.drawImage(image, 0, 0, getWidth(), getHeight(), this);
            }
        };
        ...
        JLabel photo = new JLabel(new ImageIcon(ResourceLoad.load(user.getFileName())));
        ...
        final JPanel panel_1 = new JPanel() {
            protected void paintComponent(Graphics g) {
                Image image = new ImageIcon(ResourceLoad.load("resource/imag/chart.png")).getImage();
                g.drawImage(image, 0, 0, getWidth(), getHeight(), this);
            }
        };
        ...
        final JButton label1 = new JButton() {
            protected void paintComponent(Graphics g) {
                Image image = new ImageIcon(ResourceLoad.load("resource/imag/bt1.png")).getImage();
                g.drawImage(image, 0, 0, getWidth(), getHeight(), this);
            }
        };
        ...
        final JButton label2 = new JButton() {
            protected void paintComponent(Graphics g) {
                Image image = new ImageIcon(ResourceLoad.load("resource/imag/bt1small.png")).getImage();
                g.drawImage(image, 0, 0, getWidth(), getHeight(), this);
            }
        };
        ...
        button_1.setIcon(new ImageIcon(ResourceLoad.load(user.getFileName())));
    ...
    public void showRoomList(List<RoomPojo> rooms) {
        ...
        for (int i = 0; i < rooms.size(); i++) {//房间
            ...
            if (r1.getLeftPlayer() != null) {
                ImageIcon icon = new ImageIcon(ResourceLoad.load(rooms.get(i).getLeftPlayer().getFileName()));
                leftjbutton1.setIcon(new ImageIcon(icon.getImage().getScaledInstance(45, 45, Image.SCALE_SMOOTH)));
            } else
                leftjbutton1.setIcon(new ImageIcon(ResourceLoad.load("resource/imag/kong.png")));
            ...
            Image image = new ImageIcon(ResourceLoad.load("resource/imag/table.png")).getImage().getScaledInstance(80, 80, Image.SCALE_DEFAULT);
            ...
            if (r1.getRightPlayer() != null) {
                ImageIcon icon = new ImageIcon(ResourceLoad.load(rooms.get(i).getRightPlayer().getFileName()));
                rightjbutton3.setIcon(new ImageIcon(icon.getImage().getScaledInstance(45, 45, Image.SCALE_SMOOTH)));
            } else
                rightjbutton3.setIcon(new ImageIcon(ResourceLoad.load("resource/imag/kong.png")));
