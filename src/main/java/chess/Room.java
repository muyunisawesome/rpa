...
public class Room extends JFrame {
  ...
  public void init(final int model) {// 联网对战0 人机对战1
    ...
    ready.setIcon(new ImageIcon(ResourceLoad.load("resource/imag/ready.png")));
    ...
    JPanel logoPanel = new JPanel() {
      protected void paintComponent(Graphics g) {
        Image image = new ImageIcon(ResourceLoad.load("resource/imag/room.png")).getImage();
      ...
      public void mouseClicked(MouseEvent e) {
        if (backGame == true) {
          ...
          int res = JOptionPane.showOptionDialog(null, "叫爸爸", "还想悔棋?",
              JOptionPane.DEFAULT_OPTION, JOptionPane.YES_NO_OPTION,
              new ImageIcon(ResourceLoad.load("resource/imag/back.png")), options, options[0]);
          if (res == 0) {
            if (model == 0) {//联机
  ...
  public void gameStart() {
    ...
    if (isleft) {
      ready.setIcon(new ImageIcon(ResourceLoad.load("resource/imag/black.png")));
      ready1.setIcon(new ImageIcon(ResourceLoad.load("resource/imag/white.png")));
      setCanplay(true);
    } else {
      ready.setIcon(new ImageIcon(ResourceLoad.load("resource/imag/white.png")));
      ready1.setIcon(new ImageIcon(ResourceLoad.load("resource/imag/black.png")));
    }
  ...
  public void win() {
    ...
    new Thread(new AudioPlayer(ResourceLoad.load("resource/audio/winner.wav"))).start();
    JOptionPane.showMessageDialog(this,
        "大侠，在下甘拜下风！！", "你赢了！", JOptionPane.ERROR_MESSAGE, new ImageIcon(ResourceLoad.load("resource/imag/winner.png")));
    resetGame();
  }
  ...
  public void deafeat() {
    ...
    JOptionPane.showMessageDialog(this,
        "胜败乃兵家常事，壮士请重新来过", "你输了！", JOptionPane.ERROR_MESSAGE, new ImageIcon(ResourceLoad.load("resource/imag/loser.png")));
    resetGame();
  }
